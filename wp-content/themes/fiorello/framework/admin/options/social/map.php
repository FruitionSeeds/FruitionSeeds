	...
	function fiorello_mikado_social_options_map() {
		...
		fiorello_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Share on Google Plus', 'fiorello' )
			)
		);
		...
		fiorello_mikado_add_admin_field(
			array(
				...
				'default_value' => 'no',
				'label'         => esc_html__( 'Enable Share', 'fiorello' ),
				'description'   => esc_html__( 'Enabling this option will allow sharing via Google Plus', 'fiorello' ),
				'parent'        => $panel_social_networks
			)
		);
		
		$enable_google_plus_container = fiorello_mikado_add_admin_container(
			array(
