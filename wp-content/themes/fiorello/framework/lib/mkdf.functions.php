...
if ( ! function_exists( 'fiorello_mikado_addslashes' ) ) {
	/**
	 ...
	 */
	function fiorello_mikado_addslashes( $str ) {
...
if ( ! function_exists( 'fiorello_mikado_paged_home' ) ) {
	/**
	 * Set false to on paged url on homepage
	 *
	 * @return int
	 */
	function fiorello_mikado_paged_home() {
		global $wp_query;
	...
	add_filter( 'redirect_canonical', 'fiorello_mikado_paged_home' );
}
