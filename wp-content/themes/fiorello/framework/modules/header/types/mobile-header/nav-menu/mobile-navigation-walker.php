...
if (!class_exists('FiorelloMikadoMobileNavigationWalker')) {
	class FiorelloMikadoMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="mkdf-sub-arrow arrow_triangle-right"></i><i class="arrow_triangle-down"></i></span>';
				}
			}
