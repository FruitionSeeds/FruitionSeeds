...
<div class="container">
	...
	<div id="secondary" class="widget-area course-sidebar" role="complementary">
		...
		<!-- <div class="wrapper topic-list"> -->
			<?php //echo do_shortcode('[ld_lesson_list]'); ?>
			<?php //$parent_lesson_id = learndash_get_setting( $post, 'lesson' ); ?>
			<?php //echo do_shortcode('[ld_topic_list lesson_id="901592"]'); ?>
		<!-- </div> -->
