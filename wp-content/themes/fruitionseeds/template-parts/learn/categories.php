      ...
      <div class="col">
        <div class="thumbnail carousel">
          ...
          <?php foreach( $categories as $category ) { ?>
            ...
            $link             = ($category['tile_link']) ? $category['tile_link'] : '/learn/product-category/?category=' . $product_category->slug;
            ?>
            <div class="item">
              ...
              <div class="bg" style="<?php echo bgImgFromID($image_id, 'medium', 'center', 'center', 'cover', '#DBE5AC'); ?>"></div>
            </div>
          <?php } ?>
        </div>
      </div>
